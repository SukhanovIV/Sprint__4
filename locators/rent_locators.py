...
class RentLocators:
    ...
    order = [By.XPATH, "//*[contains(@class, 'Order_Buttons')]/button[text() = 'Заказать']"]  # Кнопка "Заказать" финальная
    ...
    one_day = [By.XPATH, "//*[contains (@class, 'Dropdown-option') and contains(text(), 'сутки')]"]  # 1 сутки
    three_day = [By.XPATH, "//*[contains (@class, 'Dropdown-option') and contains(text(), 'трое суток')]"]  # 3 суток
